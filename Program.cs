...
namespace Homework_01
{
    class Program
    {
        ...
        {/*
           ...
           do
            {
                repository.DeleteWorkerByName(firstNames[i]);
                repository.Print("База данных после удаления сотрудника с именем " + firstNames[i]);
                i++;
            }

            while (repository.workersCount > 30);
            ...
            //Увольнение работников с зарплатой больше 30000
